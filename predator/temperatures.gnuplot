...
#plot "logs/temperatures.log" using 1:2 with lines linewidth 2 title "ambient"
	...
	#"logs/temperatures.log" using 1:(($7)/resistance/current_fudge/1000.0) axes x1y2 with lines linewidth 2 title "amplifier I"
	# kblogrd -r BMHDCCT:CURRENT -t 20190613000000-20190619000000d60 BM/DCCT > logs/20190613000000-20190619000000.HER-current.log
plot \
	"logs/20190613000000-20190619000000.HER-current.log" using (timecolumn(1,"%m/%d/%Y %H:%M:%S.00")):(($4)/1000.0) axes x1y2 with lines linewidth 2 title "HER", \
